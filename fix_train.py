...
parser.add_argument(
    "--checkpoint_dir", type=str, default="checkpoints_face/lite_fix", help="directory where model checkpoints are saved"
)
...
try:
    ...
    try:
        ...
        print('# ########## scuccese load model from float dir:%s, epoch: %d'%(float_dir,
                                                                  load_epoch))
    except:
